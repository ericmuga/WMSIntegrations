...
const createPDF = async (data, pdfDirPath, itemNo, part, lines) => {
    ...
    doc.autoTable({
        ...
        columnStyles: {
            ...
            3: { cellWidth: 22, fillColor: null, halign: 'left' },
            4: { cellWidth: 15, fillColor: null, halign: 'left' },
            5: { cellWidth: 22, fillColor: null, halign: 'left' },
